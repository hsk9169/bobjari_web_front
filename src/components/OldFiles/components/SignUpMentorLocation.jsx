...
const SignUpMentorLocationComp = (props) => {
    ...
    const handleSelect = idx => () => {
        const cafe = {
            place_name: state.locations[idx].place_name,
            address_name: state.locations[idx].address_name,
            road_address_name: state.locations[idx].road_address_name,
            category_group_name: state.locations[idx].category_group_name,
            content_id: state.locations[idx].id,
            place_url: state.locations[idx].place_url,
            phone: state.locations[idx].phone,
            geolocation: {
                x: state.locations[idx].x,
                y: state.locations[idx].y,
                distance: '',
            }
        };
        setState({
